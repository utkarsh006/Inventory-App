...
import com.example.inventory.domain.usecases.AddItem
import com.example.inventory.domain.usecases.DeleteItem
import com.example.inventory.domain.usecases.GetIndividualItem
...
object AppModule {
    ...
    fun provideNoteUseCases(repository: ItemRepository): ItemUseCases {
        return ItemUseCases(
            ...
            getIndividualItem = GetIndividualItem(repository)
        )
    }
